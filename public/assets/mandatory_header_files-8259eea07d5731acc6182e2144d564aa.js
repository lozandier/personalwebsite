...
(function() {
  ...
  s = "/assets/cssfilterspolyfill/lib/cssParser.js";

  s2 = "/assets/cssfilterspolyfill/lib/css-filters-polyfill.js";

  d = "/assets/reenable_turbolinks.js";
  ...
  console.log("CSS Filter test completed; The following would be called in if it failed and will disable the turbolinking feature of the site for most pages: " + s + " and the second was called in as " + s2 + ". If the test passed, turbolinks for filter-heavy pages would be enabled via " + p);
